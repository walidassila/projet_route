...
import ultralytics
import os
from tracker_utils import  yolo_to_bytetrack_detections,create_tracker
...
def trait_tracking(model,input_path,output_folder=None,conf=0.4,class_colors=None):
    if output_folder is None:
        output_folder=os.getcwd()
